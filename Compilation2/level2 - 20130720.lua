...
function levelDefeat()
	...
	local endText = display.newText("Congratulations!!!  Mission 2 Success...\n\n", 35, 55, "Arial", 16)
...
function gameStart()
	...
	--tnt:newTimer(84000, updateAlien(3), 1)
