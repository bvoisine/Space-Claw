...
local sequenceData2 = {
	name="weaponBlast",
    frames = { 15, 16, 17, 18, 18, 17, 17, 16 },
    --count=6,
...
if (gameIsActive == true) then
	...
	timerIndex[1] = timer.performWithDelay(10000, mouseRun, 1)
	timerIndex[2] = timer.performWithDelay(5000, updateWarpGate, 1)
...
function onCollision( event )
        ...
        if ( event.phase == "began" ) then
				...
				timerIndex[10] = timer.performWithDelay( 1, explodeJet(), 1)	
				end
				...
				timerIndex[11] = timer.performWithDelay( 1, explodeUFO(), 1)			
				end
				...
				score = score + 500
				screenText.text = ("Zing: " .. score)
				timerIndex[12] = timer.performWithDelay( 1, destroyMouse(), 1)			
				end
...
timerIndex[17] = timer.performWithDelay(100, stayCat, 11)
