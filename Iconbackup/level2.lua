...
-- Larger images
	spaceBG = display.newImage("spaceBG.png")
	screenGroup:insert( spaceBG )
	

	starsBG1 = display.newImage("starsBG.png")
	starsBG1.y = 315
	starsBG1.x = 240
	screenGroup:insert( starsBG1 )
	
	starsBG2 = display.newImage("starsBG.png")
	starsBG2.y = 315
	starsBG2.x = 240
	screenGroup:insert( starsBG2 )
	
	starsBG3 = display.newImage("starsBG.png")
	starsBG3.y = 316
	starsBG3.x = 760
	screenGroup:insert( starsBG3 )
